...
import { SlidersHorizontal, ChevronDown, Package, ChevronLeft, ChevronRight } from "lucide-react"
...
export function TiendaStorefront({ products, locale }: Props) {
  ...
  return (
    <div style={{ background: "#F8FAFC" }}>
      ...
      {products.length > 0 && (
        <div style={{ background: "#FFFFFF", borderTop: "1px solid #E5E7EB", padding: "44px 0 56px" }}>
