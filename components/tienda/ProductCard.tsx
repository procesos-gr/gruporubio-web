...
const cardStyles = `
  ...
  .card-qv-btn { opacity: 0; transform: translateY(6px); }
  .card-wrap:hover .card-qv-btn { opacity: 1; transform: translateY(0); }
...
export function ProductCard({
  ...
  return (
    <>
      ...
      <div className="card-wrap" style={{ position: "relative", height: "100%", display: "flex", flexDirection: "column" }}>
        <Link href={`/${locale}/tienda/${handle}`} style={{ textDecoration: "none", display: "flex", flexDirection: "column", flex: 1 }}>
          <div
            style={{
              background: "#FFFFFF",
              borderRadius: 8,
          ...
          >
            ...
            <div className="card-content" style={{
              ...
              <h3 className="card-title" style={{
                ...
                lineHeight: 1.35, marginBottom: 6, letterSpacing: "-0.2px",
              }}>
                {title}
              </h3>
